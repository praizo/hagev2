          ...
          <div className="min-h-screen bg-gray-100 px-2 xl:px-8 text-gray-800 font-sans">
            <div className="container mx-auto px-4 py-8">
              ...
              <p className="text-center text-sm text-gray-500">
                Effective Date: 08/03/2025 | Last Updated: 08/03/2025
              </p>
              ...
              <div className="space-y-8 my-8">
                <section>
                  ...
                  <p className="leading-8">
                    ...
                    "our"). We are committed to providing our services in
                    accordance with these Terms of Service. By using our website
                    (www.tryhage.com), mobile application, or interacting with
                    our services (collectively, the "Services"), you agree to
                    abide by these Terms of Service. If you do not agree, please
                ...
                <section>
                  ...
                  <p className="leading-8">
                    ...
                    will notify you of significant changes through email or by
                ...
                <section>
                  ...
                  <p className="leading-8">
                    ...
                    M5C 1C4, Canada
                    <br />
                    Email: hello@tryhage.com
                    <br />
                    Phone: +1 437-233-9069
                  </p>
                </section>
              </div>
            </div>
